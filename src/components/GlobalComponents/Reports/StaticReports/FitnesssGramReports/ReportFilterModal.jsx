...
import Heading3 from "../../../../FitnessComponents/FitnessTexts/Heading3";
...
import { reportFilterData } from "./reportsData";
		...
		<Popover placement="bottom-end" isLazy>
			...
			>
				...
				<PopoverBody
					...
					boxShadow="2xl"
				>
					<Heading3 textColor="#1890ff" mt="4">
						Report Filters
					</Heading3>
										...
										{Object.keys(assessments)?.map((each) => (
											<>
												<Box
													...
													marginRight="3"
													background={assessments[each] ? "#0081C8" : "white"}
            ...
            <Box>
              ...
              <Flex gap={8} alignItems={"center"}>
                {Object.keys(reportOutputButtons)?.map((each) => (
                  <Box
                    background="white"
                    cursor="pointer"
                    w="4.5rem"
                    ...
                    borderRadius="md"
                    border={
                      reportOutputButtons[each]
                        ? "1px solid  #0081C8"
                        : "1px solid rgb(134, 133, 133)"
                    }
                    marginRight="3"
                    background={reportOutputButtons[each] ? "#0081C8" : "white"}
                    onClick={() => handleReportOptions(each)}
                  >
                    <Paragraph2
                      textColor={reportOutputButtons[each] ? "white" : "black"}
                    >
                      {each}
                    </Paragraph2>
                  </Box>
